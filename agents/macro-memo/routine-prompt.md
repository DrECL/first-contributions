...
C. IF NO CYCLE IS OPEN FOR NEXT MONTH'S ISSUE (normally the first Monday; if the cycle is starting late, open it anyway and compress the remaining weeks — the Week 4 buffer absorbs one slipped week):
  ...
  2. THEN read the brand canon — these two are REQUIRED and govern every word you write:
     - "brand-voice.md" (doc 1Lq6SqIACAQADqdNDxvRorAADjm80mlNsghyvxyGl8q4) — the CANONICAL Macro Minded voice guide (tone spectrum, hope-based language transformations, the Macro Memo platform section, quality checklist).
     - "audience-profiles.md" (doc 1GTby4wAaYzn4-MwiVhRO5y7x5WPEfVf-X26C16RQ5u8) — who you are writing for: macro practitioners/educators (primary), macro-curious students (secondary), adjacent change agents (tertiary), the 2025–2026 priority topics, and what resonates vs. what falls flat.
     - These two .md files SUPERSEDE the older "Macro Minded Brand Voice Guide" and "Macro Minded Audience Profiles" docs in the Newsletter subfolder — on any conflict, the .md files win.
  2a. THEN read the working context: the Weekly Research Digests in Notion since the last cycle (page 004b2e4e-e7e0-823f-a200-810eeb99be16, "Macro Memo Research" section, digest-YYYY-MM-DD subpages); "Macro Memo Main Story v.1" (doc 1NQA0tJzWeHujZFy2bk-DUXc62yraqDXV6F82E7N85Sk); "Macro Memo Brains" (sheet 14FAhRC4rPt1O8yiy3vKiE9Fe9opn8PY_PcJRNvQBl7E); "Hope Based Comms Quick Guide" (pdf 1wYoT1EIDmPWZdgSvT-DPk6LuhiFhnr5u); prior issues in "Macro Memo Sent Issues" and "Macro Memo Final 6.2026" (doc 1rqSKthkC7j4mP3eq02VqdNsOPUoQFxBl47EiADYaohk). Do NOT follow the old "Macro Memo Workflow Guide" pdf or the 2025 "newsletter automation" docx files in the Newsletter subfolder — those describe superseded processes; THIS prompt is the current workflow.
